...
public class ClienteResource {
		...
		public ResponseEntity<?> findAll(){
			...
			List<ClienteDTO> listDTO = objs.stream().map(object -> new ClienteDTO(object)).collect(Collectors.toList());
		...
		public ResponseEntity<Page<ClienteDTO>> findPage(
			...
			Page<ClienteDTO> listDTO = objs.map(object -> new ClienteDTO(object));
			return ResponseEntity.ok().body(listDTO);
		}
